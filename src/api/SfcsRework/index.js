...
// 工单转移 查询数据
export function GetSNDataByOldWoOrCartonNo (query) {
  return request.get('SfcsRework/GetSNDataByOldWoOrCartonNo', {
    params: query
  })
}

// 工单转移 保存数据
export function SaveWoTransferData (query) {
  return request.post('SfcsRework/SaveWoTransferData', query)
}
