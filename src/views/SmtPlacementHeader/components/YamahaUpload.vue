<template>
  <custom-container>
    ...
    <!-- 上传抽屉modal -->
    <el-drawer :title="$t('SmtPlacementHeader._119')"
               :visible.sync="drawer"
               :model="false"
               direction="ltr"
               size="30%">
...
export default {
  ...
  data () {
    return {
      ...
      actionUrl: `${process.env.VUE_APP_API}SmtPlacementHeader/ImportYMHPlacementFile`,
      SmtStation: [],
      PcbSide: [],
