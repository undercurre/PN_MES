              ...
              <div class="kanban-wo-yield-panel kanban-panel-bg">
                <div class="block-center-content">
                  ...
                  <el-form ref="form"
                    ...
                    <!-- 标签数 -->
                     <el-form-item :label="$t('CollectProducts._68')"
                                  class="collstat-form-item">
                      <el-input v-model="Label_NO"
                                type="number"
                                min="1"
                                onkeyup="this.value=this.value.replace(/[^\d\.]/g,'')"
                                onblur="if(this.value ==0||!/^\d+(\.\d{1,2})?$/.test(this.value))this.value='1'"
                                style="width: 100%;"
                                placfeholder=" " />
                    </el-form-item>
        ...
        if (data.printer) {
          if (data.printer.isPrint) {
            ...
            if (this.Label_NO === 1) {
              ...
              var temp = []
              for (var i = 0; i < this.Label_NO; i++) {
                temp.push({ PrintTaskId: data.printer.printTaskId, Printer: this.userinfo.USER_NAME })
              }
              this.downSomething(temp)
            }
          }
        }
      }
    ...
    async ModifiesFull () {
      ...
      if (res.Result) {
        ...
        if (this.Label_NO === 1) {
          ...
          var temp = []
          for (var i = 0; i < this.Label_NO; i++) {
            temp.push({ PrintTaskId: res.Result, Printer: this.userinfo.USER_NAME })
          }
          this.downSomething(temp)
        }
      }
